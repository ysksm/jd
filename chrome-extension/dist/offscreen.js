...
return true;`);
  ...
  async function handleAction(action, payload) {
    switch (action) {
      ...
      case "SEARCH_ISSUES":
        await initDatabase();
        return await searchIssues(payload);
      case "GET_ISSUE_HISTORY": {
        await initDatabase();
        const { issueKey, field } = payload;
